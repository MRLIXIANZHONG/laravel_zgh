            ...
            <form class="layui-form tc-container mT0">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <div class="img-box clearfix">
                            ...
                            <img src="{{$craftsman->photo}}" style="width:200px;height: 150px;" class="imgBox">
                            <div id="adBtn" class="adBtn l"></div>
                        </div>
                        <input type="hidden" id="photo" name="photo" class="hide-val" data-sum="0" value="{{$craftsman->photo}}"/>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <select name="years" lay-filter="aihao">
                            <option value="2016" @if($craftsman->years == 2016) selected @endif>2016年</option>
                            <option value="2017" @if($craftsman->years == 2017) selected @endif>2017年</option>
                            <option value="2018" @if($craftsman->years == 2018) selected @endif>2018年</option>
                            <option value="2019" @if($craftsman->years == 2019) selected @endif>2019年</option>
                        </select>
                    </div>
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    ...
                    <textarea type="text"
                              ...
                              style = "width:100%;height: 180px;">@if(isset($craftsman->id)){{$craftsman->describe}}@endif
                    </textarea>
                    </div>
                </div>
    ...
    <script>
        ...
        layui.use(['form'], () => {
            ...
            form.on('submit(formHistoryCraftsman)', () => {
                $.ajax({
                    url: "{{url('/admin/history_craftsmans/'.$craftsman->id)}}",
                    data: $('form').serialize(),
                    type: 'PUT',
                    dataType: 'json',
