...
var uploadParam = {
    addr: 'http://up9.pccoo.cn/upload.ashx?filesrc=wap_fw&siteid=1507&uid=20326468&source=1'
}
var xUploader = function(opt) {
    ...
    xUploader.prototype.beforeFile = function() {
        if (_this.argments.upType == 'type1' || _this.argments.upType == 'type6') {
            this.reset();
            return true;
        }
        var flag = true;
    ...
    _this.successDo = function(url, init) {
        if (url == "文件类型不对") {
            layer.msg(url, {
                icon: 2
            });
        ...
        if (type == 'type5') {
            ...
            var html = '<li class="loading">' +
                url.substr(obj + 1) +
                '\ <a data-url="' + url + '"   class="del-file" href="javascript:;">删除</a></li>';
    ...
    xUploader.prototype.init = function() {
        _this.uploader = WebUploader.create({
            // swf文件路径
            swf: 'http://r.imgccoo.cn/website/js/webuploader/Uploader.swf',
            accept: {
