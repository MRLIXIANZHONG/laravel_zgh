...
@section('header')
    <div class="layui-inline">
        <div class="layui-btn layui-btn-small layui-btn-warm hidden-xs fresh" fresh-url="{{url('/organizationsplan')}}"><i class="layui-icon">&#x1002;</i></div>
    </div>
    <div class="layui-inline">
    ...
    <table class="layui-table" lay-even lay-skin="nob" id="app">
        ...
        @foreach($OrganizationsPlans as $item)
            <tr>
                ...
                <td>
                    <input type="checkbox" @if($item['isexcellent']===1)checked @endif value="{{$item['id']}}" lay-skin="switch">
                </td>
...
@section('js')
    <script>
        ...
        $("#senddate").click(function () {
            ...
            $.ajax({
                type: "POST",
                url: "/admin/organizationsplan/excellentselection",
