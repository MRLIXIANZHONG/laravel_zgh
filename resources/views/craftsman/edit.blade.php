        ...
        <form class="layui-form tc-container">
            ...
            <div class="layui-form-item">
                <label class="layui-form-label"><span
                            style="color:red;position: relative;top: 3px;">* </span>姓名：</label>
                <div class="layui-input-block" >
                    <input type="text" value="@if(isset($craftsman->id)){{$craftsman->username}}@endif"
                           name="username" maxlength="100" lay-verify="required" placeholder="姓名(最多100字符)"
                           autocomplete="off"
                           class="layui-input">
                </div>
            ...
            <div class="layui-form-item">
                <label class="layui-form-label"><span
                            style="color:red;position: relative;top: 3px;">* </span>联系电话：</label>
                <div class="layui-input-block">
                    <input type="phone" value="@if(isset($craftsman->id)){{$craftsman->mobile}}@endif"
            ...
            <div class="layui-form-item">
                <label class="layui-form-label"><span
                            style="color:red;position: relative;top: 3px;">* </span>职业：</label>
                <div class="layui-input-block">
                    <input type="text" value="@if(isset($craftsman->id)){{$craftsman->unit_name}}@endif"
                           name="unit_name" maxlength="100" lay-verify="required" placeholder="职业(最多100字符)"
                           autocomplete="off"
                           class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label"><span
                            style="color:red;position: relative;top: 3px;">* </span>是否是党员：</label>
                <div class="layui-input-block">
            ...
            <div class="layui-form-item">
                <label class="layui-form-label"><span
                            style="color:red;position: relative;top: 3px;">* </span>银行卡号：</label>
                <div class="layui-input-block">
                    <input type="number" value="@if(isset($craftsman->id)){{$craftsman->bank_card}}@endif"
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <div class="img-box clearfix">
                        ...
                        <div id="adBtnBank" class="adBtn l"></div>
                    </div>
            ...
            <div class="layui-form-item">
                <label class="layui-form-label"><span
                            style="color:red;position: relative;top: 3px;">* </span>户名：</label>
                <div class="layui-input-block">
                    <input type="text"
                           value="@if(isset($craftsman->id)){{$craftsman->bank_username}}@endif"
                           name="bank_username" maxlength="100" lay-verify="required" placeholder="户名(最多100字符)"
                           autocomplete="off"
                           class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label"><span
                            style="color:red;position: relative;top: 3px;">* </span>开户行：</label>
                <div class="layui-input-block">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <textarea type="text"
                              name="honor" maxlength="800" placeholder="个人履历(最多800字符)" autocomplete="off"
            ...
            <div class="layui-form-item">
                <label class="layui-form-label"><span
                            style="color:red;position: relative;top: 3px;">* </span>推荐理由：</label>
                <div class="layui-input-block">
                    <textarea type="text"
                              maxlength="2000"
            ...
            <div class="layui-form-item">
                <label class="layui-form-label"><span
                            style="color:red;position: relative;top: 3px;">* </span>分享描述：</label>
                <div class="layui-input-block">
                    <textarea type="text"
            ...
            <div class="layui-form-item">
                <div class="layui-input-block">
                    ...
                    <button type="button" onclick="storeHonor()" class="layui-btn layui-btn-normal">新增荣誉</button>
                    <button type="button" onclick="craftsmanPull()" class="layui-btn layui-btn-normal">立即推送</button>
                </div>
            </div>
        </form>
...
@section('js')
    ...
    <script>
        ...
        var honorImage = '{{$craftsman->honor_image}}';
        if (honorImage) {
            var list = honorImage.split(',');
            for (var i in list) {
                honor_image.successDo(list[i], true);
            }
        }
        ...
        layui.use(['form'], () => {
            ...
            form.on('submit(formCraftsman)', () => {
                $.ajax({
                    url: "{{url('/admin/craftsmans/'.$craftsman->id)}}",
                    data: $('form').serialize(),
                    type: 'PUT',
                    dataType: 'json',
                    success: function (res) {
