...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ env('APP_URL') }}static/admin/layui2/css/layui.css?v={{rand(0,9999)}}" />
    ...
    <script src="{{ env('APP_URL') }}static/admin/layui2/layui.js?v={{rand(0,9999)}}" type="text/javascript" charset="utf-8"></script>
    ...
    <form class="layui-form" style="width: 90%;padding-top: 20px;">
        ...
        <div class="layui-form-item">
            <div class="layui-input-block">
                <button class="layui-btn layui-btn-normal" lay-submit lay-filter="formDemo">发送消息</button>
