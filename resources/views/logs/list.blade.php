...
@section('header')
    <div class="layui-inline">
        <div class="layui-btn layui-btn-small layui-btn-warm hidden-xs fresh" fresh-url="{{url('/admin/logs')}}"><i class="layui-icon">&#x1002;</i></div>
    </div>
    <div class="layui-inline">
        <input type="text" lay-verify="title" value="{{ isset($input['title']) ? $input['title'] : '' }}" name="title" placeholder="请输入关键字" autocomplete="off" class="layui-input">
    </div>
    <div class="layui-inline">
    ...
    <div class="layui-inline">
        <input class="layui-input" id="begin" name="begin" placeholder="开始日期"  value="{{ isset($input['begin']) ? $input['begin'] : '' }}">
    </div>
    <div class="layui-inline">
