...
@section("content")
    ...
    <form class="layui-form tc-container" action="/admin/honorjudges/store" method="post">
        ...
        <div class="layui-form-item">
            <input type="hidden" value="{{$honorjudges['id']}}" name="id" autocomplete="off" class="layui-input">
        </div>

        <div class="layui-form-item">
            <label class="layui-form-label">荣耀名：</label>
            <div class="layui-input-block">
                <input type="text" maxlength="100" lay-verify="required" name="name" value="{{$honorjudges['name']}}" placeholder="请输入荣耀名(最多100个字符)" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" value="{{$honorjudges['honor_time']}}" name="honor_time" id="honor_time"  placeholder="yyyy-MM-dd" autocomplete="off" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <textarea name="content" maxlength="500" placeholder="请输入荣耀介绍(最多500个字符)" class="layui-textarea" >{{$honorjudges['content']}}</textarea>
            </div>
        </div>
    ...
    <script>
        ...
        layui.use(['form'], function () {
            ...
            form.on('submit(formDemo)', function (data) {
                this.disabled=true;
                $.ajax({
                    url: "{{url('/admin/honorjudges/edit')}}",
                    data: $('form').serialize(),
                    type: 'POST',
                    dataType: 'json',
                    success: function (res) {
