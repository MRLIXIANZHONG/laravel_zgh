...
@section("content")
    ...
    <div class="main" id="app">
        <form class="layui-form tc-container mT0">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" value="@if(isset($craftsman->id)){{$craftsman->unit_name}}@endif"
                           name="unit_name" maxlength="100" lay-verify="required" placeholder="职业(最多100字符)" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                <label class="layui-form-label"><span style="color:red;position: relative;top: 3px;">* </span>户名：</label>
                <div class="layui-input-block" style="width: 369px;">
                    <input type="text"
                           value="@if(isset($craftsman->id)){{$craftsman->bank_username}}@endif"
                           name="bank_username" lay-verify="required" maxlength="100" placeholder="户名(最多100字符)" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <div class="img-box clearfix">
                        ...
                        <div id="adBtnCover" class="adBtn l"></div>
                    </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <textarea type="text"
                          ...
                          maxlength="800"
                          style="width:990px;height: 130px;">@if(isset($craftsman->id)){{trim($craftsman->honor)}}@else @endif</textarea>
                </div>
            </div>
